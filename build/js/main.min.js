...
var _sliderJury = require("./modules/slider-jury.js");
var _video = require("./modules/video.js");
var _initAccordion = require("./modules/accordion/init-accordion.js");
var _initTabs = require("./modules/tabs/init-tabs.js");
var _sliderReviews = require("./modules/slider-reviews.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _sliderJury.initSwiperJury)();
    (0, _video.initVideo)();
    (0, _initAccordion.initAccordions)();
    (0, _initTabs.initTabs)();
    (0, _sliderReviews.initSwiperReviews)();
  });
});
...
},{"./modules/accordion/init-accordion.js":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/slider-jury.js":13,"./modules/slider-reviews.js":14,"./modules/tabs/init-tabs.js":15,"./modules/video.js":17,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
exports.initSwiperJury = void 0;
var swiperJury = document.querySelector('[data-swiper="jury"]');
var swiperButtonPrev = document.querySelector('[data-swiper-button-prev="jury"]');
var swiperButtonNext = document.querySelector('[data-swiper-button-next="jury"]');
var initSwiperJury = exports.initSwiperJury = function initSwiperJury() {
...
exports.initSwiperReviews = void 0;
var swiperReviews = document.querySelector('[data-swiper="reviews"]');
var swiperButtonPrev = document.querySelector('[data-swiper-button-prev="reviews"]');
var swiperButtonNext = document.querySelector('[data-swiper-button-next="reviews"]');
console.log(swiperButtonPrev);
console.log(swiperButtonNext);
//
//
var initSwiperReviews = exports.initSwiperReviews = function initSwiperReviews() {
...
var initVideo = exports.initVideo = function initVideo() {
